	...
	private void initCaracteristicas(BufferedImage image, int ec) {		
		...
		case 1: //YCrCb
			for (int y = 0; y < image.getHeight(); y++) {
				for (int x = 0; x < image.getWidth(); x++) {
					...
					c1[x][y] =  (float) (0.257*c.getRed() + 0.504*c.getBlue() + 0.098*c.getGreen() + 16);   //Y
					c2[x][y] = (float) (-0.148*c.getRed() - 0.291*c.getGreen() + 0.439*c.getBlue() + 128);  //Cr
					c3[x][y] =  (float) (0.439*c.getRed() - 0.368*c.getGreen() - 0.071*c.getBlue() + 128);  //Cb
				}
			}
			break;
		case 2: //HSV
		...
		case 6: //Y
			for (int y = 0; y < image.getHeight(); y++) {
				for (int x = 0; x < image.getWidth(); x++) {
					Color c = new Color(image.getRGB(x, y));
					c1[x][y] =  (float) (0.257*c.getRed() + 0.504*c.getBlue() + 0.098*c.getGreen() + 16);   //Y
					c2[x][y] =  (float) (0.257*c.getRed() + 0.504*c.getBlue() + 0.098*c.getGreen() + 16);   //Y
					c3[x][y] =  (float) (0.257*c.getRed() + 0.504*c.getBlue() + 0.098*c.getGreen() + 16);   //Y
				}
			}
			break;
		case 7: //Cr
			for (int y = 0; y < image.getHeight(); y++) {
				for (int x = 0; x < image.getWidth(); x++) {
					Color c = new Color(image.getRGB(x, y));
					c1[x][y] = (float) (-0.148*c.getRed() - 0.291*c.getGreen() + 0.439*c.getBlue() + 128);  //Cr
					c2[x][y] = (float) (-0.148*c.getRed() - 0.291*c.getGreen() + 0.439*c.getBlue() + 128);  //Cr
					c3[x][y] = (float) (-0.148*c.getRed() - 0.291*c.getGreen() + 0.439*c.getBlue() + 128);  //Cr
				}
			}
			break;
		case 8: //Cb
			for (int y = 0; y < image.getHeight(); y++) {
				for (int x = 0; x < image.getWidth(); x++) {
					Color c = new Color(image.getRGB(x, y));
					c1[x][y] =  (float) (0.439*c.getRed() - 0.368*c.getGreen() - 0.071*c.getBlue() + 128);  //Cb
					c2[x][y] =  (float) (0.439*c.getRed() - 0.368*c.getGreen() - 0.071*c.getBlue() + 128);  //Cb
					c3[x][y] =  (float) (0.439*c.getRed() - 0.368*c.getGreen() - 0.071*c.getBlue() + 128);  //Cb
				}
			}
			break;
		...
		case 12:
			break;
				...
				for (int x = 0; x < image.getWidth(); x++) {
                                        Color c = new Color(image.getRGB(x, y));					
                                        c1[x][y] =  (float) (0.299*c.getRed() + 0.587*c.getGreen() + 0.114*c.getBlue());   //Y
					c2[x][y] = (float) 0.492*(c.getBlue() - c1[x][y]);  //U
					c3[x][y] =  (float) 0.877*(c.getRed() - c1[x][y]);  //V
			...
			break;
				...
				for (int x = 0; x < image.getWidth(); x++) {
                                        Color c = new Color(image.getRGB(x, y));
                                        float y1 = (float) (0.299*c.getRed() + 0.587*c.getGreen() + 0.114*c.getBlue());   //Y
                                        float u1 = (float) 0.492*(c.getBlue() - y1);  //U
                                        c1[x][y] = u1;  
					c2[x][y] = u1;
					c3[x][y] =  u1;
			...
			break;
				...
				for (int x = 0; x < image.getWidth(); x++) {
                                        Color c = new Color(image.getRGB(x, y));
                                        float y1 = (float) (0.299*c.getRed() + 0.587*c.getGreen() + 0.114*c.getBlue());   //Y
                                        float v1 = (float) 0.877*(c.getRed() - y1);  //U
                                        c1[x][y] = v1;  
					c2[x][y] = v1;
					c3[x][y] =  v1;
